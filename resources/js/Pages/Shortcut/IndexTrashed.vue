<template>
    <MainLayout :isMain="true" :showTrashed="true">
        <div class="relative">
            ...
            <div v-else class="py-5">
                <span class="text-gray-400">Nenhum atalho foi removido.</span>
            </div>
        </div>
    </MainLayout>
</template>
...
const filter = () => form.get('/shortcut/trashed')
...
export default {
    mounted() {
        document.title = 'Meus Atalhos Excluídos - Atalhos';
    }
}
</script>
